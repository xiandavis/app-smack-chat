...
//    public private(set) var _id: String!
    public private(set) var channelTitle: String! //name: String! // Jonny using channelTitle instead because he's parsing JSON the Swift 3 way (I'm using Swift 4 way, so allegedly var name must match what is received from api)
    public private(set) var channelDescription: String! //description: String!
    public private(set) var id: String! //__v: Int? // see comment above. ? because property may not be there
}
